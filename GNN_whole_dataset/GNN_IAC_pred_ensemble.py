...
# Open report file
report = open('Report_ensemble_prediction_' + model_name + '.txt', 'w')
...
y_true    = exp_values.values[trainvalid_index]
y_pred    = ensemble_model.values[trainvalid_index]
...
y_pred     = ensemble_model.values[test_index]
y_std_pred = ensemble_model_std.values[test_index]
