...
for jj, method_name in enumerate(methods):
    ...
    df_split        = df_split[df_split[method_name].notna()]
    ...
    y_pred    = ensemble_model[trainvalid_index].values
    ...
    y_pred     = ensemble_model[test_index].values
    y_std_pred = ensemble_model_std[test_index].values
